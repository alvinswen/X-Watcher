...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("is_blue_verified", sa.Boolean(), nullable=False, server_default=sa.text("false"), comment="是否蓝标认证"),
        ...
        sa.Column("is_automated", sa.Boolean(), nullable=False, server_default=sa.text("false"), comment="是否自动化账号"),
        sa.Column("possibly_sensitive", sa.Boolean(), nullable=False, server_default=sa.text("false"), comment="是否可能包含敏感内容"),
        sa.Column("pinned_tweet_ids", sa.JSON(), nullable=True, comment="置顶推文 ID 列表"),
        sa.Column("unavailable", sa.Boolean(), nullable=False, server_default=sa.text("false"), comment="账号是否不可用"),
